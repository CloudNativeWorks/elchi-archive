...
Examples:
  ...
  sudo $0 --backend-version=elchi-v1.4.3-v0.14.0-envoy1.36.2,elchi-v1.4.3-v0.14.0-envoy1.37.0

  # Replace the existing variant with a new one
  sudo $0 --backend-version=elchi-v1.4.3-v0.14.0-envoy1.37.0 \\
          --prune-version=elchi-v1.4.3-v0.14.0-envoy1.36.2

  # Replace + add in one step (declarative — new list is the truth)
  sudo $0 --backend-version=elchi-v1.4.3-v0.14.0-envoy1.37.0,elchi-v1.4.3-v0.14.0-envoy1.38.0 \\
          --prune-missing
