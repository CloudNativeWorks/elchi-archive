...
sudo bash deploy/standalone/install.sh \
  ...
  --backend-version=elchi-v1.4.3-v0.14.0-envoy1.36.2,elchi-v1.4.3-v0.14.0-envoy1.38.0 \
  --ui-version=v1.1.9 \
...
sudo bash deploy/standalone/install.sh \
  ...
  --backend-version=elchi-v1.4.3-v0.14.0-envoy1.36.2 \
  --ui-version=v1.1.9 \
  --envoy-version=v1.37.0 \
...
|------------------|----------------------------------|---------|
| elchi-backend    | `ELCHI_DEFAULT_BACKEND_VARIANTS` | `elchi-v1.4.3-v0.14.0-envoy1.36.2` |
...
sudo bash deploy/standalone/upgrade.sh \
  --add-backend-version=elchi-v1.4.3-v0.14.0-envoy1.38.0

# Explicit prune — same effect as dropping it from --backend-version,
# but more visible in the plan banner.
sudo bash deploy/standalone/upgrade.sh \
  --backend-version=elchi-v1.4.3-v0.14.0-envoy1.38.0 \
  --prune-version=elchi-v1.4.3-v0.14.0-envoy1.36.2
...
sudo bash deploy/standalone/upgrade.sh \
  --backend-version=elchi-v1.4.3-v0.14.0-envoy1.38.0,elchi-v1.4.3-v0.14.0-envoy1.40.0 \
  --prune-missing
```
